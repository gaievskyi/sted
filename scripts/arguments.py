...
def args():
    parser = argparse.ArgumentParser(
        description="Python text beautifier. Formats texts or text files.",
    ...
    parser.add_argument("-c", "--capitals", required=False, default=False, action="store_const",
                        const=True, help="Capitalizes letters where needed (new sentence)")
    # Find mistakes [optional]
    parser.add_argument("-m", "--mistakes", required=False, default=False, action="store_const",
                        const=True, help="Finds mistakes and prints info. Only Polish supported.")
    # Print statistics [optional]
    parser.add_argument("-t", "--stats", required=False, default=False,
                        action="store_const", const=True, help="Returns the statistics of the text.")
